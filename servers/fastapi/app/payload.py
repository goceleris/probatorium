"""Deterministic JSON payloads for /json-1k and /json-64k.
...
If a future change introduces a non-ASCII char or a key Go would HTML-
escape, the conformance probe will fail loudly — keep this module's
output passing through ``orjson.dumps`` with no options set.
"""
